...
export const translations = {
    ...
    trackGoalieSaves: 'Maalivahtien torjunnat',
    goalie: 'Maalivahti',
    saves: 'Torjunnat',
    switchGoalie: 'Vaihda MV',
    addGoalie: '+ Uusi MV',
    enterGoalieNumber: 'Syötä MV:n numero tai nimi',
    savesPeriod: 'Erä',
    savesTotal: 'Yhteensä',
    savesSummaryTitle: 'Torjunnat',
    home: 'Koti',
    away: 'Vieras',
  ...
  en: {
    ...
    trackGoalieSaves: 'Track Goalie Saves',
    goalie: 'Goalie',
    saves: 'Saves',
    switchGoalie: 'Switch Goalie',
    addGoalie: '+ New Goalie',
    enterGoalieNumber: 'Enter goalie number or name',
    savesPeriod: 'Period',
    savesTotal: 'Total',
    savesSummaryTitle: 'Goalie Saves',
    home: 'Home',
    away: 'Away',
